<?php
$dsn = 'mysql:host=rdsdb-seiyou-system.crqmemsomjjy.ap-northeast-1.rds.amazonaws.com;dbname=db_seiyou_system';
$username = 'CZY_USER';
$password = '980727';
...
<?php foreach ($rec as $a) : ?>
          <?=escape1($a)?><br>
<?php endforeach; ?>
Add comment by Tinn Seiyou Add comment by seiyou2
</body>
</html>
